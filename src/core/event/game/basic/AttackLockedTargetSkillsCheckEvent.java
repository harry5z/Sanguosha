...
public class AttackLockedTargetSkillsCheckEvent extends AbstractGameEvent {
	...
	public AttackLockedTargetSkillsCheckEvent(PlayerCompleteServer source, PlayerCompleteServer target, AttackResolutionGameController controller) {
		this.source = source;
		this.target = target;
